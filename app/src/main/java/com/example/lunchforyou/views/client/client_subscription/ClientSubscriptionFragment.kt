 ...
 * Use the [ClientSubscriptionFragment.newInstance] factory method to
...
class ClientSubscriptionFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ClientSubscriptionFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ClientSubscriptionFragment().apply {
